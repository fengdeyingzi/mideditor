...
public class ChannelEvent extends MidiEvent
{
    ...
    public static final int NOTE_OFF = 0x8; //关闭发音
    public static final int NOTE_ON = 0x9; //开始发音
    public static final int NOTE_AFTERTOUCH = 0xA; //触摸键盘
    public static final int CONTROLLER = 0xB; //设置音量
    public static final int PROGRAM_CHANGE = 0xC; //切换乐器
    public static final int CHANNEL_AFTERTOUCH = 0xD; //在通道后接触(不明白啥意思)
    public static final int PITCH_BEND = 0xE; //音调
}
